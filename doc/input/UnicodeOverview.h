/*!
\page page_unicodeoverview Unicode Overview
...
The big disadvantage of this encoding scheme is code points take up more space on average than with the 
UTF-16 encoding. 

The advantages of UTF-8, however, often outweigh the disadvantages. One advantage of the UTF-8 encoding 
is that low-numbered code points, 
