/*!
\page page_buildingusingutfstring Building and Using UtfString
...
for building it on Linux will likely work for Mac OS X as well.  I plan on creating an
Xcode project for UtfString, but this hasn't been done yet.

If you wish to help improve the %UtfString library build process on Linux or Mac OS X, or even
non-primary platforms, please see the \ref page_developersnotes "Developer's Notes" for more 
information.

<ul>
<li>\ref section_buildingwindowsvs "Building UtfString on Windows using Visual Studio"</li>
<li>\ref section_usingwindowsvs "Using UtfString in Your Application on Windows using Visual Studio"</li>
<li>\ref section_buildingusingwindowsdevcpp "Building and Using UtfString on Windows using Dev-C++"</li>
<li>\ref section_linuxcommandline "Building and Using UtfString on Linux on the Command Line"</li>
<li>\ref section_macoxcommandline Building and Using UtfString on Mac OS X on the Command Line</li>
</ul>

\section section_buildingwindowsvs Building UtfString on Windows using Visual Studio
...
\note
Advanced Users: If you are already intimately familiar with building libraries under
...
\image html vssolutionconfiguration.png "The solution configuration dropdown list"

There are four solution configurations for %UtfString.

<ol>
<li>
<b>Debug</b> - Builds a %UtfString dll and export library with debug symbols and no optimization.
Use this configuration when you are using the library as a dll (recommended), and need a
debug-mode library to link against. 
</li>
<li>
<b>Release</b> - Builds a %UtfString dll and export library with no debug symbols and optimization.
Use this configuration when you are using the library as a dll (recommended), and need a 
release-mode library to link against.
</li>
<li>
<b>Static Debug</b> - Builds a static library with debug symbols and no optimization to link against. 
...
<li>
<b>Static Release</b> - Builds a static library with no debug symbols and optimization to link against. 
This is not the recommended way of building %UtfString, as it creates a huge file containing the 
entire runtime library, resulting in a great deal of unneeded code.
</li>
</ol>
...
Download the <a ref="https://sourceforge.net/project/showfiles.php?group_id=11795">
Cppunit Library</a> and unzip it to the directory where you put your C++ libraries.  Now find
...
\image html vslibrarypaths.png "Setting the paths to the CppUnit library and header files"
...
<b>Debug</b>
<ul>
<li>UtfStringd.dll - The debug version of the %UtfString library</li>
<li>UtfStringd_dll.exp - The export definitions file for the %UtfString dll: this is used to 
resolve linking issues if the export library isn't used.  This file is usually ignored in favor 
of the export library.</li>
<li>UtfStringd_dll.lib - The export library file: linking to this file resolves linking
issues when using the %UtfString library as a dll.</li>
</ul>

<b>Release</b>
<ul>
<li>UtfString.dll - The release version of the %UtfString library</li>
<li>UtfString_dll.exp - The export definitions file for the %UtfString dll: this is used to 
resolve linking issues if the export library isn't used.  This file is usually ignored in favor 
of the export library.</li>
<li>UtfString_dll.lib - The export library file: linking to this file resolves linking
issues when using the %UtfString as a dll.</li>
</ul>

<b>Static Debug</b>
<ul>
<li>UtfStringd.lib - The debug version of the the %UtfString library.  Everything needed
is contained within this library, but it's a rather large file.</li>
</ul>

<b>Static Release</b>
<ul>
<li>UtfString.lib - The debug version of the the %UtfString library.  Everything needed
is contained within this library, but it's a rather large file.</li>
</ul>

\section section_usingwindowsvs Using UtfString in Your Application on Windows using Visual Studio
...
\note
Advanced Users: If you are already intimately familiar with using libraries in your
...
\image html vslibrarypaths.png "Setting the paths to the UtfString library and header files"
...
\image html vsprojectlibraries.png "Setting the paths to the UtfString library and header files"
...
\section section_buildingusingwindowsdevcpp Building and Using UtfString on Windows using Dev-C++\
...
<ul>
<li>libUtfString.a - This is the link library to use when linking an application that uses %UtfString</li>
<li>libUtfString.def - The dll export definitions file</li>
<li>UtfString.dll - The dll containing the %UtfString library</li>
</ul>
...
\section section_linuxcommandline Building and Using UtfString on Linux on the Command Line


\section section_macoxcommandline Building and Using UtfString on Mac OS X on the Command Line
