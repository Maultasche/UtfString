/*!
\page page_manipulatingstrings Manipulating Strings
...
be easy to learn.  Take a look at the \link UtfString::Utf8String Utf8String \endlink and
\link UtfString::Utf16String Utf16String \endlink class documentation.  Many of the names of the
member functions will clearly indicate what they do, and they are all well-documented if there 
you want to know exactly what they do.
...
You should be aware that many of the functions expect certain things to be the case when they
...
to be valid (is_valid == true).  These expectations (also known as preconditions) are documented 
in the function  documentation in the %UtfString <a class="el" href="annotated.html">
Class Reference</a>. The %UtfString library expects the programmer to be aware of these.
...
mistakes in the release build.  This is a safety vs. performance tradeoff: safety checks are 
...
<a href="http://www.icu-project.org/">ICU</a> library from IBM, which contains all sorts of
...
code units.  \link UtfString::Utf8String Utf8String \endlink and \link UtfString::Utf8Char 
Utf8Char \endlink instances can be written to and read from a standard stream.  
\link UtfString::Utf16String Utf16String \endlink and \link UtfString::Utf16Char Utf16Char
\endlink instances, on the other hand, can be written to and read from both standard streams and
wide streams.

The code units string conversion operator (std::string for \link UtfString::Utf8String Utf8String 
\endlink and std::basic_string<UInt16> for \link UtfString::Utf16String Utf16String \endlink) 
converts a %UtfString into a string of code units.

\section Manipulating Code Units
...
An instance \link UtfString::Utf8String Utf8String \endlink can be cast or assigned to an
std::string and an instance of \link UtfString::Utf16String Utf16String \endlink can be cast or
assigned to an instance of std::basic_string<UInt16>.
...
Note that changing the code unit string will not changed the instance of %UtfString from
